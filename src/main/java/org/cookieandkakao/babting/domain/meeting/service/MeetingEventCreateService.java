...
public class MeetingEventCreateService {
    ...
    public MeetingEventCreateService(TalkCalendarService talkCalendarService,
        ...
        MeetingEventRepository meetingEventRepository, TimeRepository timeRepository) {
    ...
    private MeetingEvent createMeetingEvent(MemberMeeting memberMeeting,
        ...
        Time time = timeRepository.save(timeCreateRequest.toEntity());
        Event avoidEvent = eventService.saveAvoidTimeEvent(time);
